...
const About = () => {
    return (
        <div style={{ backgroundColor: '#0d0d0d', color: 'white', fontFamily: 'Arial, sans-serif', marginBottom: '0' }}><Header/>
            <section 
            ...
            >
                ...
                <Link to = "/Categories"><Button color="success" className="btn btn-primary mt-4"  href= "/Categories">Get Fit!</Button></Link>
            </section>
            ...
            <section className="text-center" style={{ backgroundColor: '#0d0d0d', paddingBottom: '0' }}>
                <h2>Contact Us</h2>
